...
public class PayosService {
    ...
    public boolean verifyWebhook(JsonNode data,String signature){if(checksumKey==null||checksumKey.isBlank())return true;if(signature==null||signature.isBlank())return false;return signature.equals(hmac(canonical(data),checksumKey));}
